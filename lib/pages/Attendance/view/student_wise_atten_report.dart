            ...
            children: [
             Container(
              ...
              Container(
                ...
                child: customText("Student Id: ${ snapshot.data!.studentId.toString() }", dark, 16.0, FontWeight.bold)),
               Container(
                         padding: EdgeInsets.only(left: 10.w, bottom: 5.h),
                alignment: Alignment.centerLeft,
                child: customText("Name: ${ snapshot.data!.studentName.toString() }", dark, 16.0, FontWeight.bold)),
                Container(
                           padding: EdgeInsets.only(left: 10.w, bottom: 5.h),
                alignment: Alignment.centerLeft,
                  child: customText("Section: ${ snapshot.data!.section.toString() }", dark, 16.0, FontWeight.bold)),
              ...
              SizedBox(height: 10.h,),
               Row(
                ...
                children: [
                  ...
                  customText("P: ${ snapshot.data!.studentName.toString() }", Colors.green, 16.0, FontWeight.bold),
