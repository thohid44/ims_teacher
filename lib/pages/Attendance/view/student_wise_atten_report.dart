...
class _StudentWishAttendenceState extends State<StudentWishAttendence> {
  ...
  fetchStudent() async {
    ...
    try {
      String url2 =
          '$url/student-wise-attendance?studentId=${_stdId.text}&month=$month&year=$selectYear';
      ...
      body: ListView(
        children: [
          ...
          stdStatus == true
              ? Padding(
                  ...
                  child: FutureBuilder(
                      ...
                      builder: ((context, AsyncSnapshot snapshot) {
                        ...
                        if (snapshot.data.attendances != null) {
                          var val = 'L';
                              ...
                              children: [
                                ...
                                Row(
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                  children: [
                                    customText("P - Present", Colors.green,
                                    ...
                                    customText("L - Leave", Colors.lightBlue,
                                        13.0, FontWeight.bold),
                                    customText("H - Holiday", Colors.yellow,
              ...
              : Center(
                  child:
                      Text("Please Select Month, Year and enter student Id")),
        ],
      ),
